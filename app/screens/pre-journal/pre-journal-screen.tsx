...
export const PreJournalScreen: FC<
  StackScreenProps<NavigatorParamList, "prejournal">
> = observer(function PreJournalScreen({ navigation }) {
  const route: RouteProp<
    { params: { purpose: "mood" | "journal" } },
    "params"
  > = useRoute()
  ...
  const title =
    route.params?.purpose === "mood" ? "Track Your Mood" : "Add Mood to Journal"
    ...
    <Screen>
      <HomeHoc title={title} subtitle="Journal" showAlternateHeader>
        <View style={styles.container}>
          {!isMoodSaved && (
            <View
              style={route.params?.purpose !== "mood" ? styles.content : null}
            >
              <FeelingBoxesInput
