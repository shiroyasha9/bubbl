...
export const MusicPlayerScreen: FC<
  StackScreenProps<NavigatorParamList, "musicPlayer">
> = observer(function MusicPlayerScreen() {
  const route: RouteProp<{ params: { video: IVideoDetails } }, "params"> =
    useRoute()
                  ...
                  <View style={styles.timers}>
                    <Text style={styles.timerText}>
                      {getDisplayDurationFromSeconds(
                        parseFloat(currentTime.toFixed(0)),
                        HHMMSS,
                      )}
                    </Text>
                    <Text style={styles.timerText}>
